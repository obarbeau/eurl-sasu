...
* Pour les SASU (régime général) : ~ 81.85% de la rémunération nette (28% de charges salariales + 54% de charges patronales) [Source](https://www.expert-comptable-tpe.fr/articles/charges-sociales-montant-salaire/)`
  ...
  assietteDividendesIR: {
    ...
    content: `[OK] - les chiffres ne sont plus bons.
Un des gros avantages des dividendes est qu'ils sont taxés à l'IR sur 60% de leur valeur,
et on peut aussi déduire la CSG de l'assiette (5,1%).
Exemple donné par [www.service-public.fr](https://www.service-public.fr/professionnels-entreprises/vosdroits/F32963) :
*Par exemple, un actionnaire ou associé qui perçoit 1 000 € de dividendes
 doit acquitter 15,5 % de prélèvements sociaux, soit 155 €,
  déductibles à hauteur de 5,1 %, soit 51 €.
  Le montant imposable des revenus distribués, soumis au barème progressif de l'impôt sur le revenu,
  est égal à 600 € (1 000 - 1 000 x 40 %) - 51 € (CSG déductible) = 549 €.*

Par ailleurs, au moment où les dividendes sont distribués,
il y a un acompte de 21% qui est prélevé à la source.
Il faudra donc l'indiquer sur sa feuille d'impôt pour qu'il soit déduit.`
  },
  impotSocietes: {
    title: "Impôt sur les sociétés",
    content: `[OK] 15% pour la partie des bénéfices en dessous de 38 120 €, 28% entre 38 120 et 500 000, et 33 % au-delà.`
  },
  assietteIS: {
    title: "Assiette impôt société",
    content: `[OK] Représente les bénéfices avant impôts sur les bénéfices.
  ...
  revenuNet: {
    title: "Revenu net",
    content: `On parle en réalité de "super-net" : tous les prélèvements sont passés sur le brut,
     y compris l'impôt sur le revenu. Ce qui reste est donc vraiment ce qui va dans la poche du freelance.`
  },
  ...
  dividendesNetsPFU: {
    ...
    content: `Représente le montant perçu par le freelance après les impôts
    car le PFU (Prélèvement Forfaitaire Unique) ou Flat-Tax est *libératoire* sur l'IR.
    [Source](https://www.economie.gouv.fr/particuliers/prelevement-forfaitaire-unique-pfu)`
  },
